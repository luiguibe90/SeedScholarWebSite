                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="viewEdifice.php" class="small-box-footer">ir <i 
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-info">
                            ...
                            <a href="addEdifice.php" class="small-box-footer">ir <i
                                    class="fas fa-arrow-circle-right"></i></a><!-- aqui agregar el archivo para agregar edificios-->
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-info">
                            ...
                            <a href="modifyEdifice.php" class="small-box-footer">ir <i
                                    class="fas fa-arrow-circle-right"></i></a><!-- crear archivo para modificar edificios-->
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-info">
                            ...
                            <a href="removeEdifice.php" class="small-box-footer">ir <i
                                    class="fas fa-arrow-circle-right"></i></a><!-- crear archivo para eliminar edificios-->
                        </div>
                    </div>
