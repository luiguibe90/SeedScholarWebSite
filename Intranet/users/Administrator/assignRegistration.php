                                ...
                                <table class="display responsive nowrap dataTable no-footer" style="width:100%; cursor: pointer;" id="tblModulos" role="grid" aria-describedby="tblModulos_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="tblModulos" rowspan="1" colspan="1" aria-label="Nombre: activate to sort column ascending" style="width: 177.2px;">Nombre</th>
                                            <th class="sorting" tabindex="0" aria-controls="tblModulos" rowspan="1" colspan="1" aria-label="Estado: activate to sort column ascending" style="width: 152px;">Estado</th>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre Completo" aria-label="Username" aria-describedby="basic-addon1" id="nombre">
                            </div>
                        </div>
                        <div class="modal-body">
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" placeholder="Aprobado / Reprobado" aria-label="Username" aria-describedby="basic-addon1" id="nombre">
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" placeholder="ACT / INC" aria-label="Username" aria-describedby="basic-addon1" id="nombre">
                            </div>
                        </div>
