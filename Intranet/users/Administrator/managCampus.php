                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="viewCampus.php" class="small-box-footer">ir <i 
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-info">
                            ...
                            <a href="addCampus.php" class="small-box-footer">ir <i
                                    class="fas fa-arrow-circle-right"></i></a><!-- aqui agregar el archivo para agregar las sedes-->
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-info">
                            ...
                            <a href="modifyCampus.php" class="small-box-footer">ir <i
                                    class="fas fa-arrow-circle-right"></i></a><!-- crear archivo para modificar campus-->
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-info">
                            ...
                            <a href="removeCampus.php" class="small-box-footer">ir <i
                                    class="fas fa-arrow-circle-right"></i></a><!-- crear archivo para eliminar campus-->
                        </div>
                    </div>
